...
@override
String toString() {
  return 'PostEntity(id: $id, name: $name, description: $description, photoUrl: $photoUrl, createdAt: $createdAt, lat: $lat, lon: $lon)';
}
...
class _PostEntity implements PostEntity {
   _PostEntity({this.id, this.name, this.description, this.photoUrl, this.createdAt, this.lat, this.lon});
